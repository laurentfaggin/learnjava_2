...
public class MyFrame extends JFrame implements KeyListener{
 ...
 MyFrame(){  
	 ...
	 icon = new ImageIcon("/home/laurent/projets/JAVA/GUI_Swing/Images/rocket.png");
	 ImageIcon iconToDisplay = TransformImage.scaleImage(icon, 42,42);
  
	 label = new JLabel();
	 label.setBounds(0, 0, 100, 100);
	 label.setIcon(iconToDisplay);
